...
def branch_and_bound_h_tree_search(problem):
    return tree_search(problem, ListaCosteH(problem))

def branch_and_bound_tree_search(problem):
    """Busqueda por ramificacion y acotacion"""
    return tree_search(problem, ListaCoste())
...
def branch_and_bound_graph_search(problem):
    """Busqueda por ramificacion y acotacion"""
    return graph_search(problem, ListaCoste())
